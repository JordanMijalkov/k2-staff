...
// import 'package:k2_flutter_core/animations/implicit/animated_scale.dart';
// import 'package:k2_flutter_core/theme/theme.dart';

// /// The base for the [KTButton].
// ///
// /// Uses an [AnimatedScale] to have the button appear pressed down while it is
// /// tapped.
// class _KTButtonBase extends StatefulWidget {
//   const _KTButtonBase({
//     @required this.child,
//     this.onTap,
//   });
...
//   @override
//   _KTButtonBaseState createState() => _KTButtonBaseState();
// }

// class _KTButtonBaseState extends State<_KTButtonBase> {
//   bool _tapDown = false;
...
// ///
// /// The [KTButton.raised] builds a button with elevation and a
// /// [backgroundColor].
// ///
// /// The [KTButton.flat] builds a flat button with a transparent background.
// ///
...
//   /// The [elevation] that changes when using a [KTButton.flat] or
//   /// [KTButton.raised].
//   final double elevation;

//   /// Determines the material type that the button uses as its background.
//   ///
//   /// Set to [MaterialType.transparency] for [KTButton.flat] and
//   /// [MaterialType.canvas] for [KTButton.raised].
