...
//  CalendarController _calendarController;
  DateTime startDate = Jiffy().startOf(Units.WEEK).dateTime;
  DateTime endDate = Jiffy().endOf(Units.WEEK).dateTime;
  ...
  K2DateTimeRange thisWeek = K2DateTimeRange(
      startTime: Jiffy().startOf(Units.WEEK).dateTime.toIso8601String(),
      endTime: Jiffy().endOf(Units.WEEK).dateTime.toIso8601String());
...
//    _calendarController = CalendarController();
  ...
  Widget build(BuildContext context) {
    ...
    final _tableCalendar = TableCalendar<K2Shift>(
      calendarBuilders: CalendarBuilders(
        singleMarkerBuilder: (context, date, _) {
          return Container(
            decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: Color.fromRGBO(51, 103, 169, 1)), //Change color
            width: 5.0,
            height: 5.0,
            margin: const EdgeInsets.symmetric(horizontal: 1.5, vertical: 9),
          );
        },
      ),
      rowHeight: 68,
      headerVisible: true,
      eventLoader: _getEventsForDay, // _getEvents(this.widget.shifts),
      //       calendarController: _calendarController,
      ...
      // firstDay:
      //     Jiffy(thisWeek.startTime).dateTime, // ?? startDate,
      // lastDay: Jiffy(thisWeek.endTime).dateTime, // ??
      // //endDate,
              ...
              child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildShiftDetails(activeShifts, width)
                    ],
                  )),
            ),
          ],
  ...
  Widget _buildShiftDetails(List<K2Shift> shifts, double width) {
    return Column(
      children: [
        shifts.length < 1
            ? Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'You are currently not scheduled on this day.',
                      style: TextStyle(
